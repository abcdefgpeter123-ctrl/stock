...
THEME_GROUPS = {
    ...
    # 8 檔代工再依近 120 日報酬相關性拆一半（分離度最佳的 4/4 切法，且與商業模式一致）：
    #   ODM 組（廣達/緯穎/緯創/鴻海）以 CSP 白牌訂單為主體，組內 0.62
    #   兼營組（英業達/技嘉/華碩/仁寶）本業是 PC／主機板，組內 0.67，兩組之間僅 0.60
    "AI伺服器ODM": {
