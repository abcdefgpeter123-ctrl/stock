...
THEME_GROUPS = {
    ...
    # 原本 11 檔同一組，但半年報酬從廣達 +8% 到川湖 +145%（差 137pt），
    # 平均在一起看不出任何訊息。依近半年日報酬相關性拆成三組：
    #   代工 8 檔組內相關 0.58–0.76（同步，差別在貝他）
    #   電源 兩檔互相 0.67，但與代工僅 0.32–0.51
    #   川湖 與所有人都最低（0.34–0.54），走勢自成一格
    "AI伺服器代工": {
        "leaders": ["2382", "6669", "2317"],
        "members": ["2357", "2356", "2376", "3231", "2324"],
    },
    "伺服器電源": {
        "leaders": ["2308"],
        "members": ["2301"],
    },
    # AI 資料中心頻寬需求帶動 800G/1.6T 光模組；
    # 聯亞在上游（InP/GaAs 磊晶與雷射晶粒），光聖在下游（光纖連接、主動光纜）
    "光通訊": {
        "leaders": ["3081"],
        "members": ["6442"],
    },
...
def generate_daily_commentary(twii, inst, all_prices, histories, api_key=None):
    ...
    THEME_MAP = {
        ...
        "2382":"AI伺服器代工","6669":"AI伺服器代工","2356":"AI伺服器代工","2376":"AI伺服器代工",
        "3231":"AI伺服器代工","2357":"AI伺服器代工","2324":"AI伺服器代工",
        "2317":"AI伺服器代工","2308":"伺服器電源","2301":"伺服器電源",
        "2059":"伺服器機構件",
